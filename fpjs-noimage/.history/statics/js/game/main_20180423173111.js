...
function setup () {
  ...
  const bestnumgen = localStorage.getItem('bestnumgen')
...
function draw () {
  ...
  log.elt.innerHTML = '<small>FPS multiplieur: ' + maxc + '</small> Frames: ' + counter + ' h(' + hard + ') : ' + ' sh(' + shard + ') : ' + birds.length + '<br>' + 
    '<h1>BEST: ' + toDate(bfrs) + ' Génération: ' + numGeneration + '<h1>'
