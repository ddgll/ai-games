...
function setup () {
  ...
  const sbox = createCheckbox('Super Hard', false)
  box.changed(() => hard = box.checked())
  sbox.changed(() => shard = sbox.checked())
...
function draw () {
  ...
  for (let i = 0; i < maxc; i++) {
    ...
    '<h1>BEST: ' + bestScore + ' <small>FPS multiplieur: ' + maxc + '</small><h1>'
