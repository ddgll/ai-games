...
function setup () {
  ...
  const sbox = createCheckbox('Ultra Hard', hhard)
  sbox.position(650, 249);
  box.changed(() => {
    hard = box.checked()
...
function draw () {
  ...
  log.elt.innerHTML = '<small>FPS multiplieur: ' + maxc + '</small> Frames: ' + counter + ' h(' + hard + ') : ' + ' sh(' + shard + ') : ' + birds.length + ' gen: ' + numGeneration + ' fr: ' + frameRate() + '<br>' + 
