...
const brains = {
  actor: new neurojs.Network.Model([
    ...
    { type: 'fc', size: 400, activation: 'relu' },
    // { type: 'fc', size: 300, activation: 'relu' },
    { type: 'fc', size: 300, activation: 'relu', dropout: 0.5 },
...
module.exports = class Bot {
  ...
  think () {
    ...
    if (this.label) {
      ...
      console.log('REWARD', this.reward, this.brain.loss)
      this.reward = 1
    }
  ...
  console(d, name, nc) {
    console.log('TIME TO Think ddpg', name, d, 'ms', nc, this.label, this.brain.age)
  }
}
