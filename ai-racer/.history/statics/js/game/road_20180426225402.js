class Road {
  ...
  contains (x, y) {
    if (this.arc) {
      return collidePointArc(x, y, this.xCenter, this.yCenter, this.width / 2, this.rotation, HALF_PI)
    } else {
      return collidePointRect(x, y, this.xCenter - this.width / 2, this.yCenter - this.width / 2, this.width, this.width)
    }
  }
  ...
  leftRightDraw () {
    ...
    if (this.xCar && this.yCar && SHOW_RACE_LINE) {
      stroke(0, 0, 255)
      line(this.xCar, this.yCar, this.xCar, this.y)
      line(this.xCar, this.yCar, this.xCar, this.y + this.width)
    }
  }
  ...
  upDownDraw () {
    ...
    if (this.xCar && this.yCar && SHOW_RACE_LINE) {
      stroke(0, 0, 255)
      line(this.xCar, this.yCar, this.x, this.yCar)
      line(this.xCar, this.yCar, this.xCarx + this.length, this.yCar)
    }
  }
  ...
  downUpDraw () {
    ...
    if (this.xCar && this.yCar && SHOW_RACE_LINE) {
      stroke(0, 0, 255)
      line(this.xCar, this.yCar, this.x, this.yCar)
      line(this.xCar, this.yCar, this.x + this.length, this.yCar)
    }
  }
