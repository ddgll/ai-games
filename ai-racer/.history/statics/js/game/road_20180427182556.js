class Road {
  ...
  collide (x, y) {
    if (this.arc) {
      if (collidePointArc(x, y, this.xCenter, this.yCenter, this.width / 2 - WALL_SIZE, this.rotation, HALF_PI)) {
        this.good = true
      }  else if (collidePointArc(x, y, this.xCenter, this.yCenter, this.width / 2, this.rotation, HALF_PI)) {
        this.good = false
      } else {
        this.good = null
      }
      ...
      if (ds <= this.width / 4 - WALL_SIZE) this.good = true
      if (df <= this.width / 4 - WALL_SIZE) this.good = true
