class Road {
  ...
  collide (x, y) {
    if (this.arc) {
      const hits = !collidePointArc(x, y, this.xCenter, this.yCenter, this.width / 2 - 4, this.rotation, HALF_PI)
      const hits2 = collidePointArc(x, y, this.xCenter, this.yCenter, this.width / 2, this.rotation, HALF_PI)
      console.log(hits, hits2)
    } else {
