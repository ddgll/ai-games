class Road {
  ...
  rightLeft () {
    this.wall = { x: this.xFin, y: this.yFin - this.width / 2, w: this.width, h: this.height }
    ...
    this.walls = [
      { x: this.xFin, y: this.yFin - this.width / 2 - WALL_SIZE, w: this.width, h: this.width + WALL_SIZE * 2 }
    ]
    // this.walls = [
