...
function Car (x, y, brain, isBest, isTest) {
  ...
  this.setSensors = function (x, y) {
    this.sensors = []
    this.obstacles = []
    for (let i = this.sensorsStart, l = this.nbSensors + this.sensorsStart, xs, ys, a; i < l; i++) {
      a = i * QUARTER_PI
  ...
  this.sense = function (circuit) {
    const obstacles = []
    for (let i = this.sensorsStart, l = this.nbSensors + this.sensorsStart, a, x, y, n, obs; i < l; i++) {
