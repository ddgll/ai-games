class Road {
  ...
  contains (x, y) {
    if (this.arc) {
      return collidePointArc(x, y, this.xCenter + 2, this.yCenter + 2, this.width / 2 - 2, this.rotation, HALF_PI)
    } else {
      return collidePointRect(x, y, this.xCenter - 2 - this.width / 2, this.yCenter - 2 - this.width / 2, this.width - 2, this.width - 2)
    }
  }
