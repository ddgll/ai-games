...
function Car (x, y, brain, isBest, isTest) {
  ...
  this.angles = [ -QUARTER_PI, 0, QUARTER_PI, -QUARTER_PI + QUARTER_PI / 2, QUARTER_PI - QUARTER_PI / 2, -HALF_PI, HALF_PI, -HALF_PI - QUARTER_PI, HALF_PI + QUARTER_PI ]
  ...
  this.think = function (circuit) {
    ...
    if (!this.label) {
      inputs.concat([ 0, 0, 0, 0, 0 ])
    } else {
      inputs.concat(this.oneHotEncode(this.label))
    }
