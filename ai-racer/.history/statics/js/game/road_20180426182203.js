class Road {
  ...
  intersects (road) {
    if (this.arc) {
      if (road.arc) {
        return collidePointArc(road.xFin, road.yFin, this.xCenter, this.yCenter, this.length / 2, this.rotation, HALF_PI)  ||
                collidePointArc(road.xCollide, road.yCollide, this.xCenter, this.yCenter, this.length / 2, this.rotation, HALF_PI)
      } else {
        return collidePointArc(road.xFin, road.yFin, this.xCenter, this.yCenter, this.length / 2, this.rotation, HALF_PI)
      }
    } else {
      return collidePointRect(road.xFin, road.yFin, this.xCenter - this.length / 2, this.yCenter - this.width / 2, this.length, this.width)
    }
  }
  ...
  leftUp () {
    ...
    this.xCollide = this.xCenter + this.length / 2 * cos(QUARTER_PI)
  ...
  rightUp () {
    ...
    this.xCenter = this.x
    this.yCenter = this.y - this.width / 4
    this.xCollide = this.xCenter + this.length / 2 * cos(3*QUARTER_PI)
