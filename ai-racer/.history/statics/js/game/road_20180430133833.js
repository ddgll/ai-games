class Road {
  ...
  collideLine(x, y, x2, y2, angle) {
    ...
    let obs = {}
    if (this.arc !== false) {
      if (!lineCircleCollide(x, y, x2, y2, this.xCenter, this.yCenter, this.wall.width - WALL_SIZE)) {
        lineCircleCollide(x, y, x2, y2, this.xCenter, this.yCenter, this.wall.width, obs)
