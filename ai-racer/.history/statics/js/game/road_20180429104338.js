class Road {
  ...
  rightLeft () {
    this.wall = { x: this.x - this.waidth, y: this.y - this.width / 2, w: this.width, h: this.height }
    this.y += WALL_SIZE
  ...
  leftRightDraw () {
    rect(this.x, this.y - this.width / 2, this.width, this.height)
  }

  rightLeftDraw () {
    rect(this.xFin, this.yFin - this.width / 2, this.width, this.height)
  }
