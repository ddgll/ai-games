class Road {
  ...
  collide (x, y) {
    if (this.arc) {
      ...
      return ds > this.width / 4 - WALL_SIZE &&
             df > this.width / 4 - WALL_SIZE &&
              !collidePointArc(x, y, this.xCenter, this.yCenter, this.width / 2 - WALL_SIZE, this.rotation, HALF_PI) && 
  ...
  getNormalizedPosition(x, y) {
    ...
    if (this.arc) {
      ...
      const xCollide = this.xCenter + this.xCenter - this.x * cos(angle)
      const yCollide = this.yCenter + this.yCenter - this.y * sin(angle)
  ...
  isHorizontal () {
    this.horizontal = (this.type == 'leftRight' || this.type == 'rightLeft' || this.type == 'upDown' || this.type == 'downUp')
    return this.horizontal
  }

  isVertical () {
    this.vertical = (this.type == 'leftRight' || this.type == 'rightLeft' || this.type == 'upDown' || this.type == 'downUp')
