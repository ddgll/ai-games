class Road {
  ...
  intersects (x, y) {
    if (this.arc) {
      return collidePointArc(x, y, this.xCenter, this.yCenter, this.length, QUARTER_PI)
    } else {
      return collidePointRect(x, y, this.xCenter, this.yCenter, this.length, QUARTER_PI)
    }
  }
