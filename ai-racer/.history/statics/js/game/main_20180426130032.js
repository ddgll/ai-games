...
function setup () {
  ...
  if (bestDna) {
    best = new Circuit(X_START, 100, DEFAULT_CIRCUIT_SIZE, JSON.parse(bestDna), true)
  }
  test = new Circuit (X_START, 100, DEFAULT_CIRCUIT_SIZE, null, true)
...
function draw () {
  ...
  const best = elites.length ? elites[0] : null
