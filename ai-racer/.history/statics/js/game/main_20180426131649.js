...
function setup () {
  ...
  log = createDiv('LOG')
  log.position(uiX, 300)
  let button = createButton('START')
  button.position(uiX, 9);
  button.mousePressed(() => {
    loop();
  })
  button = createButton('STOP')
  button.position(uiX, 49);
  button.mousePressed(() => {
    noLoop();
  })
  button = createButton('RESET')
  button.position(uiX, 89);
  button.mousePressed(() => {
    noLoop();
