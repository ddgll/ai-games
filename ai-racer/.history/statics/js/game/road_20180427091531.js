class Road {
  ...
  rightLeft () {
    ...
    this.walls = [
      { x: this.x, y: this.y - this.width / 2, w: WALL_SIZE, h: 2 },
      { x: this.x - WALL_SIZE, y: this.y - this.width / 2, w: WALL_SIZE, h: 2 }
    ]
  }
  ...
  upDown () {
    ...
    this.distance = this.width
    this.walls = [
      { x: this.x - this.width / 2, y: this.y, w: 2, h: WALL_SIZE },
      { x: this.x - WALL_SIZE + this.width / 2, y: this.y, w: 2, h: WALL_SIZE }
    ]
  }
  ...
  downUp () {
    ...
    this.walls = [
      { x: this.x - this.width / 2, y: this.y - this.width, w: 2, h: WALL_SIZE },
      { x: this.x - WALL_SIZE + this.width / 2, y: this.y - this.width, w: 2, h: WALL_SIZE }
    ]
  }
  ...
  draw () {
    ...
    this.walls.forEach(w => {
      noStroke()
      fill(255, 0, 0)
      rect(w.x, w.y, WALL_SIZE, this.width)
    })
  }
