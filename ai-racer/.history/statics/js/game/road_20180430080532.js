class Road {
  ...
  rightLeft () {
    ...
    this.wallLine = { x1: this.x - this.width + WALL_SIZE, y1: this.y - this.width / 2 + WALL_SIZE, x1: this.x + WALL_SIZE, y1: this.y + this.width / 2 + WALL_SIZE }
  ...
  draw () {
    ...
    if (DEBUG) {
      ...
      if (this.wallLine) {
        ...
        stroke(255, 255, 0)
        strokeWeight(2)
        line(this.wallLine.x1, this.wallLine.y1, this.wallLine.x2, this.wallLine.y2)
      }
    }
  }
