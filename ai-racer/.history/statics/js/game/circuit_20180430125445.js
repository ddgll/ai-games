...
class Circuit {
  ...
  checkLine(x1, y1, x2, y2, index_, seight, angle) {
    ...
    console.log('checkLine', index, x1, y1, x2, y2, seight, angle, Math.floor(seight / DEFAULT_ROAD_WIDTH))
    for (let i = index, l = Math.ceil(seight / DEFAULT_ROAD_WIDTH), r, obs, idx; i < l; i++) {
      if (i < 0) {
