class Road {
  ...
  leftUp () {
    ...
    this.width = this.width - WALL_SIZE * 2
    ...
    this.arc = { x: this.x, y: this.y - this.width / 4, w: this.width, h: this.height - WALL_SIZE * 2, a1: 0, a2: HALF_PI }
  }
  ...
  leftDown () {
    ...
    this.width = this.width - WALL_SIZE * 2
    this.arc = { x: this.x, y: this.y + this.width / 4, w: this.width, h: this.height - WALL_SIZE * 2, a1: -HALF_PI, a2: 0 }
    this.xFin = this.x + this.width / 4
    this.yFin = this.y + this.width / 4
    this.rotation = -QUARTER_PI
    this.xCenter = this.x
  ...
  rightUp () {
    ...
    this.width = this.width - WALL_SIZE * 2
    this.arc = { x: this.x, y: this.y - this.width / 4, w: this.width, h: this.height - WALL_SIZE * 2, a1: PI - HALF_PI, a2: PI }
    this.xFin = this.x - this.width / 4
    this.yFin = this.y - this.width / 4
  ...
  rightDown () {
    ...
    this.width = this.width - WALL_SIZE * 2
    this.arc = { x: this.x, y: this.y + this.width / 4, w: this.width, h: this.height - WALL_SIZE * 2, a1: PI, a2: PI + HALF_PI }
    this.xFin = this.x - this.width / 4
    this.yFin = this.y + this.width / 4
    this.rotation = -3*QUARTER_PI
    this.xCenter = this.x
  ...
  upLeft () {
    ...
    this.width = this.width - WALL_SIZE * 2
    this.arc = { x: this.x - this.width / 4, y: this.y, w: this.width, h: this.height - WALL_SIZE * 2, a1: 0, a2: HALF_PI }
    this.xFin = this.x - this.width / 4
    this.yFin = this.y + this.width / 4
    this.rotation = QUARTER_PI
  ...
  downLeft () {
    ...
    this.width = this.width - WALL_SIZE * 2
    this.height = this.height - WALL_SIZE * 2
    this.arc = { x: this.x - this.width / 4, y: this.y, w: this.width, h: this.height, a1: -HALF_PI, a2: 0 }
    this.xFin = this.x - this.width / 4
    this.yFin = this.y - this.width / 4
    this.rotation = -QUARTER_PI
    this.xCenter = this.x - this.width / 4
  ...
  upRight () {
    ...
    this.width = this.width - WALL_SIZE * 2
    this.arc = { x: this.x + this.width / 4, y: this.y, w: this.width, h: this.height - WALL_SIZE * 2, a1: PI - HALF_PI, a2: PI }
    this.xFin = this.x + this.width / 4
    this.yFin = this.y + this.width / 4
    this.rotation = 3*QUARTER_PI
    this.xCenter = this.x + this.width / 4
  ...
  downRight () {
    ...
    this.width = this.width - WALL_SIZE * 2
    this.arc = { x: this.x + this.width / 4, y: this.y, w: this.width, h: this.height - WALL_SIZE * 2, a1: PI, a2: PI + HALF_PI }
    this.xFin = this.x + this.width / 4
    this.yFin = this.y - this.width / 4
    this.rotation = -3*QUARTER_PI
    this.xCenter = this.x + this.width / 4
