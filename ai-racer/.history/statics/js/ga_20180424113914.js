...
function nextGeneration () {
  ...
  if (best) {
    localStorage.setItem('air-bestbrain', JSON.stringify(best.brain.toJSON()))
...
function calculateFitness () {
  ...
  if (bg > bestScore) {
    ...
    localStorage.setItem('bestbrain', JSON.stringify(bes.brain.toJSON()))
    localStorage.setItem('bestscore', bestScore)
    localStorage.setItem('air-bestfrs', bes.frames)
