function initGeneration (population) {
  ...
  neat = new neataptic.Neat(
    ...
    null,
    {
      mutation: [neataptic.methods.mutation.MODE_WEIGHT, neataptic.methods.mutation.MODE_BIAS, neataptic.methods.mutation.MODE_ACTIVATION],
      popsize: POPULATION,
      mutationRate: MUTATION_RATE,
      elitism: Math.round(ELITISM_PERCENT * POPULATION),
      network: new neataptic.architect.Random(13, 11, 6)
    }
  )
