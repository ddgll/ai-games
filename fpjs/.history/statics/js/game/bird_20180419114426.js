function Bird (dadBrain, momBrain, best) {  
  ...
  this.update = function (bst) {
    ...
    if (bst) {
      log.elt.innerHTML += `&nbsp;&nbsp;&nbsp;&nbsp; - BEST: ${this.score} (${this.x}, ${this.y}) v:${this.velocity} g:${this.gravity}<br>`
    } else {
      log.elt.innerHTML += `&nbsp;&nbsp;&nbsp;&nbsp; - CLONE: ${this.score} (${this.x}, ${this.y}) v:${this.velocity} g:${this.gravity}<br>`
    }
    // console.log('POSITIONS', this.positions.length)
  }
