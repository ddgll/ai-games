...
function setup () {
  ...
  roads = [
    new Road(10, 10, 'upDown'),
    new Road(60, 10, 'downUp'),
    new Road(110, 10, 'leftRight'),
    new Road(160, 10, 'rightLeft'),

    new Road(10, 60, 'leftUp'),
    new Road(60, 60, 'leftDown'),
    new Road(110, 60, 'rightUp'),
    new Road(160, 60, 'rightDown')
  ]
}
