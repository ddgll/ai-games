class Road {
  ...
  collide (x, y) {
    if (this.arc) {
      return !collidePointArc(x, y, this.xCenter, this.yCenter, this.width / 2 - 4, this.rotation, HALF_PI) && collidePointArc(x, y, this.xCenter, this.yCenter, this.width / 2, this.rotation, HALF_PI)
    } else {
