class Road {
  ...
  leftUpDraw () {
    ...
    fill(this.color)
    arc(this.x, this.y - this.width / 4, this.width - WALL_SIZE, this.width - WALL_SIZE, 0, HALF_PI)
    this.drawArcCar()
  }
  ...
  leftDownDraw () {
    ...
    fill(this.color)
    arc(this.x, this.y + this.width / 4, this.width - WALL_SIZE, this.width - WALL_SIZE, -HALF_PI, 0)
    this.drawArcCar()
  }
  ...
  rightUpDraw () {
    ...
    fill(this.color)
    arc(this.x, this.y - this.width / 4, this.width - WALL_SIZE, this.width - WALL_SIZE, PI - HALF_PI, PI)
    this.drawArcCar()
  }
  ...
  rightDownDraw () {
    ...
    fill(this.color)
    arc(this.x, this.y + this.width / 4, this.width - WALL_SIZE, this.width - WALL_SIZE, PI, PI + HALF_PI)
    this.drawArcCar()
  }
  ...
  upLeftDraw () {
    ...
    fill(this.color)
    arc(this.x - this.width / 4, this.y, this.width - WALL_SIZE, this.width - WALL_SIZE, 0, HALF_PI)
    this.drawArcCar()
  }
  ...
  downLeftDraw () {
    ...
    fill(this.color)
    arc(this.x - this.width / 4, this.y, this.width - WALL_SIZE, this.width - WALL_SIZE, -HALF_PI, 0)
    this.drawArcCar()
  }
  ...
  upRightDraw () {
    ...
    fill(this.color)
    arc(this.x + this.width / 4, this.y, this.width - WALL_SIZE, this.width - WALL_SIZE, PI - HALF_PI, PI)
    this.drawArcCar()
  }
  ...
  downRightDraw () {
    ...
    fill(this.color)
    arc(this.x + this.width / 4, this.y, this.width - WALL_SIZE, this.width - WALL_SIZE, PI, PI + HALF_PI)
    this.drawArcCar()
  }
